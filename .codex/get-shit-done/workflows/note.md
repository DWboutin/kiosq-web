...
- **Global scope**: `/Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/notes/`)
...
2. Glob `/Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/notes/` — works in any directory
