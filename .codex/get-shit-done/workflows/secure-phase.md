...
```
Task(
  prompt="Read /Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/get-shit-done/templates/SECURITY.md`
