...
```bash
INIT=$(node "/Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/get-shit-done/templates/spec.md.
