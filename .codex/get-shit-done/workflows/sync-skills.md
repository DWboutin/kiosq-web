...
INSTALL_JS_GLOBAL="/Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/mikaelboutin/Desktop/coding-projects/kiosq-web/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
