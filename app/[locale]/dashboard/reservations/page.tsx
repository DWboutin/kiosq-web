import { DashboardProfileReservations } from "@/components/client-pages/dashboard-profile-reservations/dashboard-profile-reservations";
...
export default async function DashboardReservationsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        <DashboardProfileReservations reservationsData={reservations} />
      </div>
    </div>
  );
}
