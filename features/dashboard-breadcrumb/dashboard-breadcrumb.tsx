...
export const DashboardBreadcrumb: FC = () => {
  ...
  return (
    <div className="w-full py-4 px-5 max-md:px-2 max-md:py-2 overflow-hidden">
      <div className="flex flex-row justify-start items-center w-full gap-2 overflow-x-auto whitespace-nowrap text-lg max-md:text-base [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
